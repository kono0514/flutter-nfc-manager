...
class NfcManagerPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    ...
    when (call.method) {
      "Nfc#isAvailable" -> handleNfcIsAvailable(call, _result)
      "Nfc#startSession" -> handleNfcStartSession(call, _result)
      "Nfc#stopSession" -> handleNfcStopSession(call, _result)
      "Nfc#disposeTag" -> handleNfcDisposeTag(call, _result)
      "Ndef#read" -> handleNdefRead(call, _result)
      "Ndef#write" -> handleNdefWrite(call, _result)
      "Ndef#writeLock" -> handleNdefWriteLock(call, _result)
      "NfcA#transceive" -> handleNfcATransceive(call, _result)
      "NfcB#transceive" -> handleNfcBTransceive(call, _result)
      "NfcF#transceive" -> handleNfcFTransceive(call, _result)
      "NfcV#transceive" -> handleNfcVTransceive(call, _result)
      "IsoDep#transceive" -> handleIsoDepTransceive(call, _result)
      "MifareClassic#authenticateSectorWithKeyA" -> handleMifareClassicAuthenticateSectorWithKeyA(call, _result)
      "MifareClassic#authenticateSectorWithKeyB" -> handleMifareClassicAuthenticateSectorWithKeyB(call, _result)
      "MifareClassic#increment" -> handleMifareClassicIncrement(call, _result)
      "MifareClassic#decrement" -> handleMifareClassicDecrement(call, _result)
      "MifareClassic#readBlock" -> handleMifareClassicReadBlock(call, _result)
      "MifareClassic#writeBlock" -> handleMifareClassicWriteBlock(call, _result)
      "MifareClassic#restore" -> handleMifareClassicRestore(call, _result)
      "MifareClassic#transfer" -> handleMifareClassicTransfer(call, _result)
      "MifareClassic#transceive" -> handleMifareClassicTransceive(call, _result)
      "MifareUltralight#readPages" -> handleMifareUltralightReadPages(call, _result)
      "MifareUltralight#writePage" -> handleMifareUltralightWritePage(call, _result)
      "MifareUltralight#transceive" -> handleMifareUltralightTransceive(call, _result)
      "NdefFormatable#format" -> handleNdefFormatableFormat(call, _result)
      "NdefFormatable#formatReadOnly" -> handleNdefFormatableFormatReadOnly(call, _result)
